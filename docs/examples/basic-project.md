...
**Complete example: basic-project**

[[docs](../README.md) > [examples](./README.md) > basic-project]

---

## Overview

This example demonstrates a complete basic-project project using Crew.
...
export async function createPlan(ctx) {
  const plan = ctx.createPlan('basic-project');
