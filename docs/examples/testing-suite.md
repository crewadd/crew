# testing-suite Example

**Complete example: testing-suite**

[[docs](../README.md) > [examples](./README.md) > testing-suite]

---

## Overview

This example demonstrates a complete testing-suite project using Crew.
...
export async function createPlan(ctx) {
  const plan = ctx.createPlan('testing-suite');
